...
def generate_students(filename='new_students.xlsx', students_number=99, male_proportion=0.5, special_needs_proportion=0.2, with_id_proportion=0.3):
    ...
    ws.append(['ID', 'FirstName', 'MiddleName', 'FamilyName', 'Gender', 'WithID', 'OldSchool', 'OldSchoolClass', 'G1', 'G2', 'G3', 'G4', 'G5', 'MeanValue', 'Preput','PreputClassroom','SpecialNeeds', 'Notes'])
